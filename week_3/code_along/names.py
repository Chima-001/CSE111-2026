...
print(make_full_name('Nnaji', 'Chimamkpam'))
print(make_full_name('Xavier', 'Rodriquez'))
print(make_full_name('Loius', 'De-Angelou'))
print()
print(extract_family_name('Nnaji Chimamkpam'))
print(extract_family_name('Xavier Rodriquez'))
print(extract_family_name('Loius De-Angelou'))
print()
print(extract_given_name('Nnaji Chimamkpam'))
print(extract_given_name('Xavier Rodriquez'))
print(extract_given_name('Loius De-Angelou'))